    ...
    return (
      <div className="min-h-screen bg-[#F8F4EC] p-8 flex flex-col items-center justify-center space-y-4">
        <div className="bg-red-50 text-red-800 p-6 rounded-2xl max-w-md w-full text-center space-y-2 border border-red-200">
          ...
          <Link href={`/lawyer/cases/${caseId}`} className="mt-4 inline-block px-4 py-2 bg-red-100 font-semibold rounded-lg text-red-900 hover:bg-red-200">
            Return to Case
          </Link>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-[#FFFDF8] border border-[#E2D5C1] rounded-3xl p-6 shadow-xs">
                  ...
                  <div className="mt-4 pt-4 border-t border-[#E2D5C1]/40 print:hidden">
                    <Link href={`/lawyer/cases/${caseId}?tab=research`} className="text-[10px] font-bold text-[#A66A22] uppercase tracking-wider flex items-center gap-1 hover:underline">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-[#FFFDF8] border border-[#E2D5C1] rounded-3xl p-6 shadow-xs">
                  ...
                  <div className="mt-4 pt-4 border-t border-[#E2D5C1]/40 print:hidden">
                    <Link href={`/lawyer/cases/${caseId}?tab=documents`} className="text-[10px] font-bold text-[#A66A22] uppercase tracking-wider flex items-center gap-1 hover:underline">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#FFFDF8] border border-[#E2D5C1] rounded-3xl p-6 shadow-xs">
                ...
                <div className="mt-4 pt-4 border-t border-[#E2D5C1]/40 print:hidden">
                  <Link href={`/lawyer/cases/${caseId}?tab=tasks`} className="text-[10px] font-bold text-[#A66A22] uppercase tracking-wider flex items-center gap-1 hover:underline">
